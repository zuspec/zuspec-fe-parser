...
class ElemFactoryList : public virtual ElemFactoryAssocDataBase {
public:
    ElemFactoryList(dmgr::IDebugMgr *dmgr);

    virtual ~ElemFactoryList();
    ...
    static ElemFactoryList *create(dmgr::IDebugMgr *dmgr) {
        return new ElemFactoryList(dmgr);
    }
