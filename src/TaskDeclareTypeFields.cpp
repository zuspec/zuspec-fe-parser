...
TaskDeclareTypeFields::TaskDeclareTypeFields(IAst2ArlContext *ctxt) : m_ctxt(ctxt) {
    DEBUG_INIT("zsp::fe::parser::TaskDeclareTypeFields", ctxt->getDebugMgr());
    m_type = 0;
    m_depth = 0;
}

TaskDeclareTypeFields::~TaskDeclareTypeFields() {

}

void TaskDeclareTypeFields::build(ast::ISymbolScope *root) {
    DEBUG_ENTER("build");
    ...
    TaskBuildTypeFunctions(m_ctxt, 0).build(root);
...
void TaskDeclareTypeFields::visitPackageImportStmt(ast::IPackageImportStmt *i) {

}

void TaskDeclareTypeFields::visitSymbolFunctionScope(ast::ISymbolFunctionScope *i) {
...
void TaskDeclareTypeFields::visitSymbolTypeScope(ast::ISymbolTypeScope *i) {
...
void TaskDeclareTypeFields::visitAction(ast::IAction *i) {
...
//        vsc::dm::IDataType *super_t = TaskDeclareTypeFields(m_ctxt).buildT<vsc::dm::IDataType>(i->getSuper_t());
...
void TaskDeclareTypeFields::visitActivityDecl(ast::IActivityDecl *i) {
...
void TaskDeclareTypeFields::visitComponent(ast::IComponent *i) {
...
void TaskDeclareTypeFields::visitDataTypeBool(ast::IDataTypeBool *i) { 
    DEBUG_ENTER("visitDataTypeBool");
    m_type = m_ctxt->ctxt()->getDataTypeCore(vsc::dm::DataTypeCoreE::Bool);
    DEBUG_LEAVE("visitDataTypeBool");
}

void TaskDeclareTypeFields::visitDataTypeChandle(ast::IDataTypeChandle *i) { 
    DEBUG_ENTER("visitDataTypeChandle");

    DEBUG_LEAVE("visitDataTypeChandle");
}

void TaskDeclareTypeFields::visitDataTypeEnum(ast::IDataTypeEnum *i) { 
...
void TaskDeclareTypeFields::visitDataTypeInt(ast::IDataTypeInt *i) { 
...
void TaskDeclareTypeFields::visitDataTypePyObj(ast::IDataTypePyObj *i) {
...
void TaskDeclareTypeFields::visitDataTypeString(ast::IDataTypeString *i) {
...
void TaskDeclareTypeFields::visitDataTypeUserDefined(ast::IDataTypeUserDefined *i) { 
...
void TaskDeclareTypeFields::visitSymbolEnumScope(ast::ISymbolEnumScope *i) {
...
void TaskDeclareTypeFields::visitExecBlock(ast::IExecBlock *i) {
    DEBUG_ENTER("visitExecBlock");
    DEBUG_LEAVE("visitExecBlock");
}

void TaskDeclareTypeFields::visitExecScope(ast::IExecScope *i) {
    DEBUG_ENTER("visitExecScope");
    DEBUG_LEAVE("visitExecScope");
}

void TaskDeclareTypeFields::visitStruct(ast::IStruct *i) {
...
void TaskDeclareTypeFields::visitTypeIdentifier(ast::ITypeIdentifier *i) {
...
void TaskDeclareTypeFields::visitTypeScope(ast::ITypeScope *i) {
...
void TaskDeclareTypeFields::visitField(ast::IField *i) { 
...
void TaskDeclareTypeFields::visitFieldCompRef(ast::IFieldCompRef *i) {
...
void TaskDeclareTypeFields::visitFieldRef(ast::IFieldRef *i) {
...
void TaskDeclareTypeFields::visitFieldClaim(ast::IFieldClaim *i) {
    DEBUG_ENTER("visitFieldClaim");

    DEBUG_LEAVE("visitFieldClaim");
}
    
void TaskDeclareTypeFields::buildType(
...
void TaskDeclareTypeFields::buildTypeConstraints(
    std::map<std::string, ast::IConstraintScope *>      &c_inherit_m,
    vsc::dm::IDataTypeStruct                            *arl_type,
    ast::ISymbolTypeScope                               *ast_type) {
...
void TaskDeclareTypeFields::buildTypeFields(
...
//        vsc::dm::IDataType *super_t_arl = TaskDeclareTypeFields(m_ctxt).build(super_t_ast);
...
void TaskDeclareTypeFields::buildTypeExecs(
        std::vector<int32_t>        &off_l,
        vsc::dm::IDataTypeStruct    *arl_type,
        ast::ISymbolTypeScope       *ast_type) {
...
void TaskDeclareTypeFields::buildTypeFunctions(
        std::map<std::string, ast::IConstraintScope *>      &c_inherit_m,
        vsc::dm::IDataTypeStruct                            *arl_type,
        ast::ISymbolTypeScope                               *ast_type) {
...
std::string TaskDeclareTypeFields::getNamespacePrefix() {
    std::string ret;
...
vsc::dm::IAccept *TaskDeclareTypeFields::findType(ast::IScopeChild *ast_t) {
    return m_ctxt->findType(ast_t);
}

ast::IScopeChild *TaskDeclareTypeFields::resolvePath(ast::ISymbolRefPath *ref) {
...
zsp::parser::TaskResolveSymbolPathRefResult TaskDeclareTypeFields::resolveTypePath(ast::ISymbolRefPath *ref) {
    ast::ISymbolScope *scope = m_ctxt->rootSymScopeT<ast::ISymbolScope>();
    return zsp::parser::TaskResolveSymbolPathRef(
        m_ctxt->getDebugMgr(), 
...
dmgr::IDebug *TaskDeclareTypeFields::m_dbg = 0;
