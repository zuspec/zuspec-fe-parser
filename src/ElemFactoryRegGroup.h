...
class ElemFactoryRegGroup : public virtual ElemFactoryAssocDataBase {
public:
    ElemFactoryRegGroup(dmgr::IDebugMgr *dmgr);

    virtual ~ElemFactoryRegGroup();
